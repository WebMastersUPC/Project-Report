...
|36|E6-US102|Información de entregables de proyectos|**Como** desarrollador **quiero** funciones de información de los entregables de proyectos **para** que los usuarios puedan manipular la información de los entregables de proyectos|5|
...
<img src="./assets/C4-model/structurizr-87476-WebMastersSystemContext.png">

### 4.6.2. Software Architecture Container Diagrams.

<img src="./assets/C4-model/structurizr-87476-WebMastersContainer.png">

### 4.6.3. Software Architecture Components Diagrams.

#### Login and Registration Bounded Context

<img src="./assets/C4-model/structurizr-87476-LoginAndRegistrationComponent.png">

#### Developer Profile Bounded Context

<img src="./assets/C4-model/structurizr-87476-DeveloperProfileComponent.png">

#### Enterprise Profile Bounded Context

<img src="./assets/C4-model/structurizr-87476-EnterpriseProfileComponent.png">

#### Project Proposal and Hire a Developer Bounded Context

<img src="./assets/C4-model/structurizr-87476-ProjectProposalAndHireADeveloperComponent.png">

#### Apply for Projects Bounded Context

<img src="./assets/C4-model/structurizr-87476-ApplyForProjectComponent.png">

#### Project Development Bounded Context

<img src="./assets/C4-model/structurizr-87476-ProjectDevelopmentComponent.png">

#### Tech Support Bounded Context

<img src="./assets/C4-model/structurizr-87476-TechnicalSupportComponent.png">
...
<img src="./assets/ApiExecution/AuthProfile.png" alt="Profile and Authentification Endpoints" style=" width : 80%">
...
| Enterprise, Developer, Project | /api/Project/  |<img src="./assets/sprint3/Project Sprint 5.png">|
...
<table style="width:100%; height:100px;">
   ...
   <tr>
    ...
    <tr>
      ...
      <th> T12</th>
      <th> Conexion del backend con el frontend de mensajeria </th>
      <th> Implementar la conexión entre el backend y el frontend para mostrar y gestionar los mensajes del usuario. Esto incluye la integración de los endpoints necesarios y la lógica de negocio asociada.</th>
      <th> 5</th>
      <th> Joseph Llacchua  </th> 
      <th> Done </th>
   </tr>
   <tr>
      <th> T13 </th>
      <th> Envio de mensajes</th>
      <th> Implemntacion para la creacion de menasjes para los usuarios</th>
      <th> 4 </th>
      <th> Joseph Llacchua </th> 
      <th> Done </th>
   </tr>
    <tr>
      ...
      <th> T14</th>
      <th> Conexion del backend con el frontend de soporte</th>
      <th> Desarrollar la funcionalidad que permita al usuario crear nuevos tickets de soporte desde el frontend, conectándose a los endpoints correspondientes en el backend y asegurando que los datos se gestionen correctamente  </th>
      <th> 5</th>
      <th> Joseph Llacchua  </th> 
      <th> Done </th>
   </tr>
   <tr>
      <th> T15 </th>
      <th> Envio de solicitudes de roportes</th>
      <th> Implementacion para la creacion de solicitudes de soporte paralos usuarios</th>
      <th> 4 </th>
      <th> Joseph Llacchua </th> 
      <th> Done </th>
   </tr>
...
| User, Developer, Enterprise     | /api/v1/auth/                      | <img src="./assets/sprint3/auth-swagger.png"> |  
| **Bounded Context** | **Project**  ||
| Enterprise, Developer, Project | /api/v1/Project/  |<img src="./assets/sprint3/Project-Swagger.png">|
...
| **Bounded Context** | **Messages**  ||
| User, Message     | /api/v1/Messages/  | <img src="./assets/sprint3/mess-swagger.png"> | 
| **Bounded Context** | **Support**  ||
| User,  Support   |  /api/v1/SupportRequest/ | <img src="./assets/sprint3/supp-swagger.png"> | 
...
URL: https://sitewebmasters.netlify.app

<img src="./assets/sprint3/landingpage-deployment.png">

**Aplicacion web deployment**

URL: https://webmaster-app.netlify.app/login

<img src="./assets/sprint3/software-deployment.png">

**API web aplication**

URL: https://webmasterapi.azurewebsites.net/index.html
